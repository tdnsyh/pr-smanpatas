...
@section('content')
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-md-4 g-3">
                @foreach ($highlighted as $agenda)
                    <div class="col">
                        <div class="card h-100 border bg-glass shadow-none">
                            ...
                            <div class="card-body d-flex flex-column">
                                <a href="{{ route('agenda.show', $agenda->slug) }}" class="text-decoration-none">
                                    <h5 class="fw-bold mb-0 text-dark card-title">
    ...
    <section class="py-4">
        <div class="container">
            ...
            <h1 class="fw-semibold mt-2">Agenda Lainnya</h1>
